  ...
  afterCreate: function(createdRecord, cb)
  {
    ...
    .exec(function(err,person){
      ...
      mail.email = {
        ...
        html: '<html><body><h1>Your Invite Code</h1><a href="epicapp://?id=' + createdRecord.id + '&password=' + createdRecord.password + '">Add meeting to Epic Protection App</a></body></html>',
        attachments: []
      };
